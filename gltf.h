...
typedef enum {
    ...
    GLTF_MESH_PRIMITIVE_ATTRIBUTE_TYPE_JOINTS      = 1,
    GLTF_MESH_PRIMITIVE_ATTRIBUTE_TYPE_WEIGHTS     = 2,
    GLTF_MESH_PRIMITIVE_ATTRIBUTE_TYPE_NORMAL      = 3,
    GLTF_MESH_PRIMITIVE_ATTRIBUTE_TYPE_TANGENT     = 4,
    GLTF_MESH_PRIMITIVE_ATTRIBUTE_TYPE_TEXCOORD    = 5,
    GLTF_MESH_PRIMITIVE_ATTRIBUTE_TYPE_COLOR       = 6,
